...
insert  into `tr_orders`(`orderNumber`,`orderDate`,`requiredDate`,`shippedDate`,`status`,`comments`,`customerNumber`) values 
...
CREATE TABLE `tr_orderdetails` (
  ...
  CONSTRAINT `orderdetails_ibfk_1` FOREIGN KEY (`orderNumber`) REFERENCES `tr_orders` (`orderNumber`)
);

/*Data for the table `orderdetails` */

insert  into `tr_orderdetails`(`orderNumber`,`productCode`,`quantityOrdered`,`priceEach`,`orderLineNumber`) values 
